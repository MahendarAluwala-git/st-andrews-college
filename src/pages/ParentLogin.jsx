        ...
        <div className="max-w-md w-full">
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-primary-600 to-primary-700 px-8 py-10 text-center">
              ...
              <h2 className="text-3xl font-bold text-white mb-2">Parent Portal</h2>
              <p className="text-white/80 text-sm">Access your child's academic information</p>
            </div>
            ...
            <div className="p-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link to="/parent/forgot-password" className="text-sm text-primary-600 hover:text-primary-700 font-medium">
                    Forgot Password?
                  </Link>
                </div>
              ...
              <div className="mt-6 text-center">
                <p className="text-sm text-secondary-600">
                  New user?{' '}
                  <Link to="/parent/register" className="text-primary-600 hover:text-primary-700 font-medium">
                    Register here
                  </Link>
                </p>
              </div>
